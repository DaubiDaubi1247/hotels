...
public class DirectorServiceImpl implements DirectorService {
    ...
    public DirectorDto addDirector(@Valid DirectorDto directorDto) throws DirectorAlreadyExist {
        ...
        Optional<DirectorEntity> directorEntity = directorRepository.findByFcsOrPhoneIgnoreCase(directorDto.getFcs(), directorDto.getPhone());
        ...
        DirectorEntity directorEntityForCreate = DirectorMapper.INSTANSE.directorToDirectorEntity(directorDto);
